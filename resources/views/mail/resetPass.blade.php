                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        align="left">
                                                                                        <h1 style="color: #4a7eb0;">You have been requested to reset your password account.</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10b"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            {{ ucwords($user->name['fname']) . ' ' . ucwords($user->name['lname']) }},
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        align="left">
                                                                                        <p>
                                                                                            We hope that you are fine and safe, your reset password code is<br>
                                                                                            <h4>{{$user->code}}</h4><br>
                                                                                            Now you can reset password of your account using this code.<br>
