                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        align="left">
                                                                                        <h1 style="color: #4a7eb0;">Your account
                                                                                            ({{ ucwords($doctor->name['fname_en']) . ' ' . ucwords($doctor->name['lname_en']) }})
                                                                                            has been accepted now you can create clinics through our website and get clients.</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        align="left">
                                                                                        <p>
                                                                                            We hope that you are fine and safe, your account now is available to create clinics on the website.<br>
