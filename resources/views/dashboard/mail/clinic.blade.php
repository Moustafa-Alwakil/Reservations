...
*/
        ...
        [data-ogsb] .es-button.es-button-1628357584486 {
                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="3089" align="center">
                                        <table class="es-header-body" width="600" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p10b es-p10r es-p10l"
                                                        align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image"
                                                                                        ...
                                                                                        style="font-size: 0px;"><a
                                                                                            href="{{ route('index') }}"
                                                                                            target="_blank"><img
                                                                                                src="https://demo.stripocdn.email/content/guids/dc1d1e8f-181c-442b-8e86-442906050646/images/87811628357594302.png"
                                                                                                alt="Smart home logo"
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p5r es-p5l"
                                                        style="background-color: #4a7eb0;" bgcolor="#4a7eb0"
                                                        align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        ...
                                                                                        <h1 style="color: #4a7eb0;">Your 
                                                                                            {{ ucwords($clinic->name['name_en']) }}
                                                                                            has been accepted now you can get online reservations to your clinic through our website.</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10b"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            {{ ucwords($clinic->physican->name['fname_en']) . ' ' . ucwords($clinic->physican->name['lname_en']) }},
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text"
                                                                                        align="left">
                                                                                        <p>
                                                                                            We hope that you are fine and safe, your clinic now is available to patients on the website.<br>
                                                                                            Thanks for Choosing our website to provide your medical services.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p20b"
                                                                                        align="left"><span
                                                                                            class="es-button-border"><a
                                                                                                ...
                                                                                                target="_blank"
                                                                                                style="border-width: 10px 25px;">Go To My Dashboard</a></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
