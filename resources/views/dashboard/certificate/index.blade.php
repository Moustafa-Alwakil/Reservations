                    ...
                    <table class="datatable table table-stripped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$certificate->university['university_ar']}} - {{$certificate->university['university_en']}}</td>
                                <td>{{$certificate->field['field_ar']}} - {{$certificate->field['field_en']}}</td>
                                ...
                                <td>{{ucwords($certificate->physican->name['fname_ar'].' '.$certificate->physican->name['lname_ar'])}} - {{ucwords($certificate->physican->name['fname_en'].' '.$certificate->physican->name['lname_en'])}}</td>
                                <td>
