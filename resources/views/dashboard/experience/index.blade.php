                            ...
                            <tbody>
                                @foreach ($experiences as $experience)
                                    <tr>
                                        ...
                                        <td>{{ ucwords($experience->physican->name['fname_ar'] . ' ' . $experience->physican->name['lname_ar']) }}
                                        </td>
                                        <td>{{ ucwords($experience->physican->name['fname_en'] . ' ' . $experience->physican->name['lname_en']) }}
                                        </td>
                                        <td>
                                            @can('update')
