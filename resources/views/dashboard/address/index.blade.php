                    ...
                    <table class="datatable table table-stripped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('addresses.edit',['address'=>$address->id])}}" class="btn btn-warning">Edit</a>
                                    <form method="POST" class="d-inline" action="{{route('addresses.destroy',['address'=>$address->id])}}">
                                        @csrf
                                        @method('DELETE')
