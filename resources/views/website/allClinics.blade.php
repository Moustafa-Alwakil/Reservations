                                            ...
                                            <div class="doc-info-left">
                                                <div class="doctor-img">
                                                    <a href="{{ route('clinic', ['id' => $address->clinic->id]) }}">
                                                        <img src="{{ $address->clinic->physican->info->photo }}" class="img-fluid" alt="Doctor Image">
                                                    </a>
                                                </div>
                                                <div class="doc-info-cont">
                                                    <h4 class="doc-name"><a
                                            ...
                                            <div class="doc-info-right">
                                                <div class="clini-infos">
                                                    <ul>
                                                        ...
                                                        <li><i class="far fa-comment"></i> {{ $address->clinic->physican->reviews_count }}
                                                            Feedback</li>
                                                        <li><i
                                                                class="fas fa-map-marker-alt"></i>{{ ucwords($region->name['name_' . LaravelLocalization::getCurrentLocale()]) }},
                                                            {{ ucwords($clinicsByCity->name['name_' . LaravelLocalization::getCurrentLocale()]) }}
                                                        </li>
                                                        <li><i class="far fa-money-bill-alt"></i> {{ $address->clinic->examfee->price }}
                                                            EGP
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="clinic-booking">
                                                    <a class="view-pro-btn" href="{{ route('clinic', ['id' => $address->clinic->id]) }}">View
                                                        Profile</a>
                                                    @if (!Auth::guard('doc')->check() && !Auth::guard('web')->check())
                                                        <a class="apt-btn" href="{{ route('user.login') }}">Book Appointment</a>
                                                    @endif
                                                    @auth('web')
                                                        <a class="apt-btn" href="{{ route('appointment.create', ['id' => $address->clinic->id]) }}">Book
                                                            Appointment</a>
                                                    @endauth
                                                </div>
                                            </div>
